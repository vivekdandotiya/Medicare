...
<div x-data="chatbotEngine()" class="fixed bottom-6 right-6 z-[9999] font-sans">
    
    <!-- Floating Toggle Button -->
    <button @click="toggleOpen()" 
            class="w-14 h-14 bg-gradient-to-tr from-teal-500 to-emerald-600 hover:from-teal-650 hover:to-emerald-700 text-white rounded-full flex items-center justify-center shadow-xl shadow-teal-500/30 hover:scale-105 active:scale-95 transition-all duration-300 border border-teal-400/20 relative">
        <!-- Chat Icon -->
    ...
    <div x-show="open" 
        ...
        <div class="bg-gradient-to-r from-slate-900 to-teal-950 p-4 text-white flex justify-between items-center border-b border-teal-950/20">
            ...
            <button @click="toggleOpen()" class="text-slate-400 hover:text-white transition p-1 hover:bg-white/10 rounded-lg">
        ...
        <div id="chatbot-messages-box" class="flex-1 p-4 overflow-y-auto space-y-3.5 scroll-smooth bg-slate-50/40">
            ...
            <div class="pt-2 flex flex-wrap gap-2">
                <button type="button" @click="sendSuggestion('I have a fever')" class="bg-teal-50 hover:bg-teal-100 border border-teal-500/10 hover:border-teal-500/20 text-teal-700 text-[10px] font-bold px-3 py-1.5 rounded-full transition shadow-sm">🤒 Fever</button>
                <button type="button" @click="sendSuggestion('I have a cough')" class="bg-teal-50 hover:bg-teal-100 border border-teal-500/10 hover:border-teal-500/20 text-teal-700 text-[10px] font-bold px-3 py-1.5 rounded-full transition shadow-sm">😷 Cough/Cold</button>
                <button type="button" @click="sendSuggestion('I have a headache')" class="bg-teal-50 hover:bg-teal-100 border border-teal-500/10 hover:border-teal-500/20 text-teal-700 text-[10px] font-bold px-3 py-1.5 rounded-full transition shadow-sm">🤕 Headache</button>
                <button type="button" @click="sendSuggestion('I need multivitamins')" class="bg-teal-50 hover:bg-teal-100 border border-teal-500/10 hover:border-teal-500/20 text-teal-700 text-[10px] font-bold px-3 py-1.5 rounded-full transition shadow-sm">💊 Multivitamins</button>
            </div>
